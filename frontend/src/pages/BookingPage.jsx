...
// Reached via /book/:propertyId?type=rent|buy
...
const BookingPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Step 2: If online payment → initiate SSLCommerz and redirect
      if (form.payment_method === 'online') {
        const { data: payData } = await initiatePayment(booking.id);
        // Redirect to SSLCommerz payment gateway
        window.location.href = payData.payment_url;
      } else {
        // Meet & pay → go to confirmation page
        ...
        <div className="booking-layout">
          ...
          <div className="booking-form-wrap">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Booking type — only show if property allows both */}
              ...
              <div className="field">
                ...
                <div className="payment-methods">
                  ...
                  <label className={`pay-option ${form.payment_method === 'online' ? 'selected' : ''}`}>
                    <input
                  ...
                  <label className={`pay-option ${form.payment_method === 'meet_pay' ? 'selected' : ''}`}>
                    <input
